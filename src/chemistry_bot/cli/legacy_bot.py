"""Older parallel CLI bot variant kept for architectural comparison.

This module preserves the pre-RAG or non-RAG-oriented chat path while the
RAG-enabled bot remains the main experimental direction.
"""
...
class CliBot:
    """Interactive chemistry bot for the older parallel CLI path."""
